...
USER_AGENT = "Mozilla/5.0 (compatible; Stash-a T7tAl7zam scraper)"
STUDIO_NAME = "تحت الحزام"
STUDIO_SLUG = "t7t-al7zam"
STUDIO_URL = "https://t7t-al7zam.com/"
...
def strip_site_suffix(title: str) -> str:
    return re.sub(r"\s+-\s+تحت الحزام\s*$", "", title).strip()
