...
def listing_page_url(seed_url, page_number):
...
def extract_source_title(url, document):
...
def hydrate(url):
    return getattr(Nafak, "scrape_" + "scene_by_url")(url)
...
BaseSource.run_scene_by_url = hydrate
BaseSource.main()
